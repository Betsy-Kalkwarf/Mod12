...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sortedOTUs = otu_ids.sort((a,b) => b.sample_values - a.sample_values);
    console.log(sortedOTUs);
    var yticks = sortedOTUs.slice(0,10);
    console.log(yticks);

    yticks_OTU = yticks.map(y => `OTU ${y}`);
    console.log(yticks_OTU)
